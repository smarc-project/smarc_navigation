...
void CorrespondenceClass::computeH(const h_comp h_comps,
    ...
    h_1.setZero(3,9);
    h_1.block(0,0,3,3) = Eigen::MatrixXd::Identity(3,3);

    using namespace std;
    h_1(0, 3) = lm_odom.getY()*(h_comps.s_3*h_comps.s_5 + h_comps.c_3*h_comps.c_5*h_comps.s_4) + lm_odom.getZ()*(h_comps.c_3*h_comps.s_5 - h_comps.c_5*h_comps.s_4*h_comps.s_3);
    h_1(0, 4) = h_comps.c_5*(lm_odom.getZ()*h_comps.c_4*h_comps.c_3 - lm_odom.getX()*h_comps.s_4 + lm_odom.getY()*h_comps.c_4*h_comps.s_3);
    h_1(0, 5) = lm_odom.getZ()*(h_comps.c_5*h_comps.s_3 - h_comps.c_3*h_comps.s_4*h_comps.s_5) - lm_odom.getY()*(h_comps.c_3*h_comps.c_5 + h_comps.s_4*h_comps.s_3*h_comps.s_5) - lm_odom.getX()*h_comps.c_4*h_comps.s_5;
    h_1(0, 6) = h_comps.c_4*h_comps.c_5;
    h_1(0, 7) = h_comps.c_5*h_comps.s_4*h_comps.s_3 - h_comps.c_3*h_comps.s_5;
    h_1(0, 8) = h_comps.s_3*h_comps.s_5 + h_comps.c_3*h_comps.c_5*h_comps.s_4;

    h_1(1, 3) = - lm_odom.getY()*(h_comps.c_5*h_comps.s_3 - h_comps.c_3*h_comps.s_4*h_comps.s_5) - lm_odom.getZ()*(h_comps.c_3*h_comps.c_5 + h_comps.s_4*h_comps.s_3*h_comps.s_5);
    h_1(1, 4) = h_comps.s_5*(lm_odom.getZ()*h_comps.c_4*h_comps.c_3 - lm_odom.getX()*h_comps.s_4 + lm_odom.getY()*h_comps.c_4*h_comps.s_3);
    h_1(1, 5) = lm_odom.getZ()*(h_comps.s_3*h_comps.s_5 + h_comps.c_3*h_comps.c_5*h_comps.s_4) - lm_odom.getY()*(h_comps.c_3*h_comps.s_5 - h_comps.c_5*h_comps.s_4*h_comps.s_3) + lm_odom.getX()*h_comps.c_4*h_comps.c_5;
    h_1(1, 6) = h_comps.c_4*h_comps.s_5;
    h_1(1, 7) = h_comps.c_3*h_comps.c_5 + h_comps.s_4*h_comps.s_3*h_comps.s_5;
    h_1(1, 8) = h_comps.c_3*h_comps.s_4*h_comps.s_5 - h_comps.c_5*h_comps.s_3;

    h_1(2, 3) = h_comps.c_4*(lm_odom.getY()*h_comps.c_3 - lm_odom.getZ()*h_comps.s_3);
    h_1(2, 4) = - lm_odom.getX()*h_comps.c_4 - lm_odom.getZ()*h_comps.c_3*h_comps.s_4 - lm_odom.getY()*h_comps.s_4*h_comps.s_3;
    h_1(2, 5) = 0;
    h_1(2, 6) = -h_comps.s_4;
    h_1(2, 7) = h_comps.c_4*h_comps.s_3;
